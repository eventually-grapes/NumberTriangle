...
public class NumberTriangle {
    ...
    public int retrieve(String path) {
        if (path.equals("")) {
            ...
            NumberTriangle tempTriangle = this;
            for (String lr: path.split("")) {
                if (lr.equals("l")) {
                    tempTriangle = tempTriangle.left;
                }
                if (lr.equals("r")) {
                    tempTriangle = tempTriangle.right;
                }
            }
            return tempTriangle.root;
        }
    }
        ...
        while (line != null) {
            ...
            if (nums.length == 1) {
                ...
                for (int i = 0; i<nums.length-1; i++) {
                    prevRow.get(i).setLeft(row.get(i));
                    prevRow.get(i).setRight(row.get(i+1));
                }
            }
            prevRow = row;
